<script lang="ts">
  ...
  <div class="flex justify-center items-center gap-3 pt-12 flex-wrap">
    <Card img="../img/1.jpg" class="mb-4 w-72 bg-light-100 dark:bg-dark-200 hover:bg-white" >
      ...
      <Button class="bg-dark-100 dark:bg-dark-100 dark:hover:bg-dark-300 dark:hover:text-white dark:border-dark-100 hover:bg-white hover:text-dark-100 hover:border-solid border-2 hover:border-2 hover:border-dark-100" style="cursor: url(../img/pointer.png), pointer;">
        Live Preview
      </Button></a>
    </Card>

    <Card img="../img/movies.jpg" class="mb-4 w-72 bg-light-100 dark:bg-dark-200 hover:bg-white">
    ...
    <Card img="../img/cosmetic.jpg" class="mb-4 w-72 bg-light-100 dark:bg-dark-200 hover:bg-white">
      ...
      <Button class="bg-dark-100 dark:bg-dark-100 dark:border-dark-100 dark:hover:bg-dark-300 dark:hover:text-white hover:bg-white hover:text-dark-100 hover:border-solid border-2 hover:border-2 hover:border-dark-100" style="cursor: url(../img/pointer.png), pointer;">
        Live Preview
      </Button></a>
    </Card>


    <Card img="../img/ava.jpg" class="mb-4 w-72 bg-light-100 dark:bg-dark-200 hover:bg-white">
